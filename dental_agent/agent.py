...
from dental_agent.config.settings import TEMPERATURE
...
# Swapped from ChatXAI to ChatGroq
# REPLACE the string below with your free Groq API key from console.groq.com
llm = ChatGroq(
